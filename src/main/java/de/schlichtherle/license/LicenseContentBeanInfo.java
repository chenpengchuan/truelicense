...
//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_consumerAmount] = new PropertyDescriptor ( "consumerAmount", LicenseContent.class, "getConsumerAmount", "setConsumerAmount" ); // NOI18N
            properties[PROPERTY_consumerType] = new PropertyDescriptor ( "consumerType", LicenseContent.class, "getConsumerType", "setConsumerType" ); // NOI18N
            properties[PROPERTY_extra] = new PropertyDescriptor ( "extra", LicenseContent.class, "getExtra", "setExtra" ); // NOI18N
            properties[PROPERTY_holder] = new PropertyDescriptor ( "holder", LicenseContent.class, "getHolder", "setHolder" ); // NOI18N
            properties[PROPERTY_info] = new PropertyDescriptor ( "info", LicenseContent.class, "getInfo", "setInfo" ); // NOI18N
            properties[PROPERTY_issued] = new PropertyDescriptor ( "issued", LicenseContent.class, "getIssued", "setIssued" ); // NOI18N
            properties[PROPERTY_issuer] = new PropertyDescriptor ( "issuer", LicenseContent.class, "getIssuer", "setIssuer" ); // NOI18N
            properties[PROPERTY_notAfter] = new PropertyDescriptor ( "notAfter", LicenseContent.class, "getNotAfter", "setNotAfter" ); // NOI18N
            properties[PROPERTY_notBefore] = new PropertyDescriptor ( "notBefore", LicenseContent.class, "getNotBefore", "setNotBefore" ); // NOI18N
            properties[PROPERTY_subject] = new PropertyDescriptor ( "subject", LicenseContent.class, "getSubject", "setSubject" ); // NOI18N
        }
